 var mensData = [
  ...
  //    var count = "cart"+cart.length;
  //    var obj = {"name":mensData[i].name,"url":mensData[i].image_url,"price":mensData[i].price,"id":count};
  //    cart.push(obj);
  ...
  var wbtn = document.getElementsByClassName("wbtn");
  document.getElementById("cart-count11").textContent = WishList.length;
  for(let i=0;i<wbtn.length;i++){
    wbtn[i].addEventListener("click",function(){
     var count = "WishList"+WishList.length;
     var obj = {"name":mensData[i].name,"url":mensData[i].image_url,"price":mensData[i].price,"id":count};
     WishList.push(obj);
    ...
    for(var i = 0; i < images.length; i++) {
        ...
        var image = images[1];
        image.onclick = function(event) {
             window.location.href = this.id + 'p2.html';
        };
      }
      ...
      var images = document.getElementsByTagName("img");
        ...
        var image = images[2];
        image.onclick = function(event) {
             window.location.href = this.id + 'p3.html';
        };
      }
      ...
      var images = document.getElementsByTagName("img");
        ...
        var image = images[3];
        image.onclick = function(event) {
             window.location.href = this.id + 'p4.html';
        };
      }
      ...
      var image = images[4];
      image.onclick = function(event) {
           window.location.href = this.id + 'p5.html';
      };
    }
    ...
    var image = images[5];
    image.onclick = function(event) {
         window.location.href = this.id + 'p6.html';
    };
  }
